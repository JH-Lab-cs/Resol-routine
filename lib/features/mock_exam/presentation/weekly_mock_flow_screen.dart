...
class WeeklyMockFlowScreen extends ConsumerStatefulWidget {
  ...
  @override
  ConsumerState<WeeklyMockFlowScreen> createState() =>
      _WeeklyMockFlowScreenState();
}

class _WeeklyMockFlowScreenState extends ConsumerState<WeeklyMockFlowScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    if (!_started) {
      ...
      return Scaffold(
        appBar: AppBar(title: const Text('주간 모의고사')),
        body: Padding(
          ...
          child: Column(
            ...
            children: [
              ...
              Text(
                '문제 순서는 듣기 10문제 후 독해 10문제로 고정됩니다.',
