...
class DailyReportAggregate(Base):
    __tablename__ = "daily_report_aggregates"
    __table_args__ = (
        UniqueConstraint("student_id", "day_key", name="uq_daily_report_aggregates_student_day_key"),
    )
