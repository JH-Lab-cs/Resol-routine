...
from app.api.ai_content_internal import router as ai_content_internal_router
from app.api.ai_internal import router as ai_internal_router
from app.api.ai_tts_internal import router as ai_tts_internal_router
...
api_router.include_router(ai_content_internal_router)
api_router.include_router(ai_internal_router)
api_router.include_router(ai_tts_internal_router)
