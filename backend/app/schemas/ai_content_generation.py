...
class AIContentGenerationFailureCode(StrEnum):
    ...
    OUTPUT_INVALID_TURN_COUNT = "OUTPUT_INVALID_TURN_COUNT"
    OUTPUT_INVALID_RESPONSE_OPTIONS = "OUTPUT_INVALID_RESPONSE_OPTIONS"
    OUTPUT_INVALID_EVIDENCE_TURN = "OUTPUT_INVALID_EVIDENCE_TURN"
    OUTPUT_DETERMINISTIC_COMPILE_FAILED = "OUTPUT_DETERMINISTIC_COMPILE_FAILED"
